...
Assignments will be submitted using the [Marmoset server](https://cs.ycp.edu/marmoset/). You will receive an email containing the username and password you will use for this server.
